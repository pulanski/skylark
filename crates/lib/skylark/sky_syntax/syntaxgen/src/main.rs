...
const STARLARK_UNGRAMMAR: &str = "parser/src/grammar/starlark.ungram";

/// The **generated syntax kinds** for the **Starlark language** from
/// `starlark.ungram`
const STARLARK_KINDS: &str = "parser/src/ast/generated/kinds.rs";

/// The **generated syntax tokens** for the **Starlark language**
/// from `starlark.ungram`
const STARLARK_TOKENS: &str = "parser/src/ast/generated/tokens.rs";

/// The **generated syntax nodes** for the **Starlark language** from
/// `starlark.ungram`
const STARLARK_NODES: &str = "parser/src/ast/generated/nodes.rs";
